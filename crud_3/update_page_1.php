...
if(isset($_GET['id'])){
    ...
    $query = "SELECT * FROM public.produk_3 where id = '{$id}' "; // menghubungkan database
...
<?php 
    if(isset($_POST['update_products'])){
        ...
        $query = "UPDATE public.produk_3 SET judul_produk = '{$name}', deskripsi_produk = '{$description}', harga = '{$price}', gambar = '{$image}'  WHERE id = '{$idnew}'";
